...
//    	
//    	//return String.format("serialVersionUID:%d, ownerId:%s, isSend:%s, relateId:%d, msgFromUserId:%s, msgFromName:%s, msgFromUserNick:%s, msgFromUserAvatar:%s, msgType:%d, msgOverview:%s, ", )
//	}
